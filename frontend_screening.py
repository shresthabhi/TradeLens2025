...
#     with st.expander("➕ Add More Filters"):
#         selected_filters = {}
#         for col, label in readable_labels.items():
...
#     latest_data = df.sort_values("public_date").groupby("permno").tail(1)
#     display_df = latest_data[important_columns].rename(columns=display_labels)

#     st.subheader("📄 Filtered Results")
#     st.dataframe(display_df, use_container_width=True)

#     st.download_button("📥 Download Filtered Data", display_df.to_csv(index=False), "filtered_data.csv", "text/csv")
...
#         "Solvency Ratios": ["de_ratio", "debt_assets", "debt_at", "debt_capital", "intcov", "intcov_ratio"],
